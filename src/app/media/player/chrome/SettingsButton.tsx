...
import { IContentDescriptor } from "./settings/IContentDescriptor";
import { Popup, PopupType } from "./settings/Popup";
...
export class SettingsButton extends Component<ISettingsButtonProps, {}> {
  ...
  showPopup(content: IContentDescriptor, type: PopupType, parent?: Popup) {

  }

  open() {
    this._svgElement.classList.add("chrome-button-menu-open");
    this._menuOpen = true;
  }
  
  close() {
    this._svgElement.classList.remove("chrome-button-menu-open");
